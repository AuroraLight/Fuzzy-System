...
class GUI:
    ...
    def run(self):
        rbfn_parameter = [self.iteration_entry.get(), self.numberOfGroup_entry.get(), self.matingProbability_entry.get(), self.mutationProbability_entry.get(), self.numberOfHiddenLayerNeurons_entry.get()]
    ...
    def init_label(self):
        ...
        self.mating_probability_label = tk.Label(self.master, text='交配機率:')
        self.mutation_probability_label = tk.Label(self.master, text='突變機率:')
    ...
    def init_entry(self):
        ...
        var_matingProbability = tk.StringVar()
        var_mutationProbability = tk.StringVar()
        var_numberOfHiddenLayerNeurons = tk.StringVar()

        var_iteration.set('7')
        var_numberOfGroup.set('5')
        var_matingProbability.set('0.8')
        var_mutationProbability.set('0.1')
        var_numberOfHiddenLayerNeurons.set('4')
        ...
        self.matingProbability_entry = tk.Entry(self.master, textvariable=var_matingProbability)
        self.mutationProbability_entry = tk.Entry(self.master, textvariable=var_mutationProbability)
    ...
    def place_component(self):
        ...
        # third row
        self.mating_probability_label.place(x=second_column, y=first_row + spacing * 2)
        self.matingProbability_entry.place(x=third_column, y=first_row + spacing * 2)
        # 4th row
        self.mutation_probability_label.place(x=second_column, y=first_row + spacing * 3)
        self.mutationProbability_entry.place(x=third_column, y=first_row + spacing * 3)
        # 5th row
